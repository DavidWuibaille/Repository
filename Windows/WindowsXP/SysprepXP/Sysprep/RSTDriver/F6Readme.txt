************************************************************
************************************************************
*  Installation Readme for F6 Floppy Utility 
*  (F6flp32.exe or F6flp64.exe).
*
...
1.  In Microsoft* Windows*, double-click on the executable
    to run.

2.  Follow the steps to copy the floppy disk image onto a
    floppy.


*Other names and products may be claimed as the property of others.
